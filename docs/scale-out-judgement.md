...
| verdict | ボタン表示 | 色・強さ | モック該当 |
| --- | --- | --- | --- |
| `required` | ⊕ 増車必要（不足◯台/◯kg） | 赤系・常時強調 | `dnd-card-scaleout-badge` |
| `recommended` | ⊕ AIで増車プランを見る | インディゴ・標準 | `btn-ai-scaleout` |
| `negotiate` | ⚠ 要交渉（手配困難） | 橙・別系統 | （新規・協力会社モーダル誘導） |
